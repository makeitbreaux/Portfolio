        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="BookFriend"
              description="Book Friend offers users the opportunity to search their favorite author’s information as well as a comprehensive list of all of the author’s works. The back-end side of Book Friend was built using Express and Node, utilizing jsonchema to validate JSON documents, and jsonwebtoken and bcrypt to authorize and authenticate users. The front-end side was built using React and Bootstrap 4. PostgreSQL was chosen as the database, and testing was done using Jest and React Testing Library. Data from the Open Library API was used."
